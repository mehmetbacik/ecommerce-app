				...
				<Box my={5} textAlign="left">
					<form onSubmit={formik.handleSubmit}>
						...
						<FormControl mt="4">
							...
							<Input name="password" type="password" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.mpassword} isInvalid={formik.touched.password && formik.errors.password}/>
						</FormControl>
						<FormControl mt="4">
						...
						<Button mt="4" width="full" type="submit">Register</Button>
					</form>
				</Box>
			</Box>
		</Flex>
